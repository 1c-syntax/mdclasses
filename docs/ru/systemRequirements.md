...
На данный момент библиотека разрабатывается с использованием Java 21, но в рамках сборочных конвейеров происходит проверка работоспособности при использовании более свежих версий, в частности версии Java 20.
