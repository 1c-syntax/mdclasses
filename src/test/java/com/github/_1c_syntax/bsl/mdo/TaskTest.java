...
//    assertThat(attribute.getSynonym().getContent()).isEmpty();
...
//    assertThat(tabularSection.getSynonym().getContent())
//      .hasSize(1)
...
//    assertThat(form.getSynonym().getContent())
//      .hasSize(1)
...
//    assertThat(command.getSynonym().getContent())
//      .hasSize(1)
