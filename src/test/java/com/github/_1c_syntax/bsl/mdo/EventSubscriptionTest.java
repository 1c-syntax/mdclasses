...
class EventSubscriptionTest extends AbstractMDObjectTest<EventSubscription> {
  ...
  @Test
  void test() {
    var mdo = getMDObject("EventSubscriptions/ПодпискаНаСобытие1");
    checkBaseField(mdo, MDOType.EVENT_SUBSCRIPTION,
      "ПодпискаНаСобытие1", "4da21a7b-3d07-4e6d-b91f-7e1c8ddcffcd",
      ObjectBelonging.OWN);
