...
class InformationRegisterTest extends AbstractMDObjectTest<InformationRegister> {
  ...
  void testEdt(ArgumentsAccessor argumentsAccessor) {
    ...
    assertThat(template.getMetadataName()).isEqualTo("Template");
    assertThat(template.getSynonyms().getContent())
      .hasSize(1)
    ...
    assertThat(attribute.getMetadataName()).isEqualTo("Resource");
