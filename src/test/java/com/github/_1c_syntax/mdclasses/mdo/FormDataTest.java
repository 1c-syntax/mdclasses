...
class FormDataTest {
  ...
  @Test
  void testEDT() {
    var path = Path.of("src/test/resources/metadata/edt/src/Catalogs/Справочник1/Forms/ФормаСписка/Form.form");
  ...
  @Test
  void testDesigner() {
    var path = Path.of("src/test/resources/metadata/original/Catalogs/Справочник1/Forms/ФормаСписка/Ext/Form.xml");
  ...
  private void checkFormData(FormData formData) {
    assertThat(formData.getPlainChildren()).hasSize(34);
  }
