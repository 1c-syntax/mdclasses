...
class TemplateDataTest {
  ...
  private void checkTemplates(Configuration configuration) {
    ...
    assertThat(commonTemplates).hasSize(8)
      .extracting(MDObjectBase.class::cast)
  ...
  private void checkCommonTemplate(List<MDObjectBase> commonTemplates) {
  ...
  private void checkTemplate(List<MDObjectBase> templates) {
