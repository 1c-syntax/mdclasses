...
/**
 * <p>Java class for ChartOfAccountsChildObjects complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ChartOfAccountsChildObjects"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="AccountingFlag" type="{http://v8.1c.ru/8.3/MDClasses}AccountingFlag" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ExtDimensionAccountingFlag" type="{http://v8.1c.ru/8.3/MDClasses}ExtDimensionAccountingFlag" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ChartOfAccountsChildObjects", propOrder = {
    "attribute",
    "tabularSection",
    "accountingFlag",
...
public class ChartOfAccountsChildObjects {
    ...
    @XmlElement(name = "ExtDimensionAccountingFlag")
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the accountingFlag property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAccountingFlag().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AccountingFlag> getAccountingFlag() {
        if (accountingFlag == null) {
            accountingFlag = new ArrayList<AccountingFlag>();
        }
        return this.accountingFlag;
    }

    /**
     * Gets the value of the extDimensionAccountingFlag property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the extDimensionAccountingFlag property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getExtDimensionAccountingFlag().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ExtDimensionAccountingFlag }
     * 
     * 
     */
    public List<ExtDimensionAccountingFlag> getExtDimensionAccountingFlag() {
        if (extDimensionAccountingFlag == null) {
            extDimensionAccountingFlag = new ArrayList<ExtDimensionAccountingFlag>();
        }
        return this.extDimensionAccountingFlag;
    }
