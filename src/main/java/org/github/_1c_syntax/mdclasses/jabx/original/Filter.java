 ...
 *       &lt;sequence&gt;
 *         &lt;element name="FilterItem" type="{http://v8.1c.ru/8.1/data/enterprise}FilterItem" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Filter", namespace = "http://v8.1c.ru/8.1/data/enterprise", propOrder = {
    "filterItem"
})
public class Filter {
    ...
    public List<FilterItem> getFilterItem() {
        if (filterItem == null) {
            filterItem = new ArrayList<FilterItem>();
        }
