 ...
 * 
 */
@XmlType(name = "EditType", namespace = "http://v8.1c.ru/8.3/xcf/enums")
@XmlEnum
public enum EditType {

    @XmlEnumValue("InList")
    IN_LIST("InList"),
    @XmlEnumValue("InDialog")
    IN_DIALOG("InDialog"),
