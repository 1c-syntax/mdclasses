...
/**
 * <p>Java class for DocumentJournalChildObjects complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DocumentJournalChildObjects"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Column" type="{http://v8.1c.ru/8.3/MDClasses}ColumnMD" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "DocumentJournalChildObjects", propOrder = {
    "column",
    "form",
    "template",
    "command"
})
public class DocumentJournalChildObjects {

    @XmlElement(name = "Column")
    protected List<ColumnMD> column;
     ...
     * 
     */
    public List<ColumnMD> getColumn() {
        if (column == null) {
            column = new ArrayList<ColumnMD>();
        }
        return this.column;
    }
