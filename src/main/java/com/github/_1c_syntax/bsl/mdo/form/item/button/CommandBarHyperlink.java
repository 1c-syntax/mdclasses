 ...
 */
package com.github._1c_syntax.bsl.mdo.form.item.button;
...
/**
 * Элемент формы: Гиперссылка командной панели
 */
@Value
@Builder
@ToString(of = {"name", "id"})
public class CommandBarHyperlink implements ButtonItem {
  /**
   * Имя элемента
   */
  @Builder.Default
