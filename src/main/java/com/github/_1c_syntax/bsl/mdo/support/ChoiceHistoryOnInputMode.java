...
public enum ChoiceHistoryOnInputMode implements EnumWithName {
  AUTO("Auto", "Авто"),
  DONT_USE("DontUse", "НеИспользовать"),
  UNKNOWN("unknown", "неизвестный");

  private static final Map<String, ChoiceHistoryOnInputMode> KEYS = EnumWithName.computeKeys(values());

  @Getter
  @Accessors(fluent = true)
  private final MultiName fullName;

  ChoiceHistoryOnInputMode(String nameEn, String nameRu) {
   ...
   */
  public static ChoiceHistoryOnInputMode valueByName(String string) {
