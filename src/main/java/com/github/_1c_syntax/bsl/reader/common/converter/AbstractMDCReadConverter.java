 ...
 */
public abstract class AbstractMDCReadConverter implements ReadConverter {

  private final String configurationExtensionFilter;

  protected AbstractMDCReadConverter(String configurationExtensionFilter) {
    this.configurationExtensionFilter = configurationExtensionFilter;
  }
  ...
  public Object unmarshal(HierarchicalStreamReader reader, UnmarshallingContext context) {
    ...
    try (var scanner = new Scanner(fileInputStream, StandardCharsets.UTF_8)) {
      count = (int) scanner.findAll(configurationExtensionFilter).count();
    }
