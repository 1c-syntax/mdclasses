...
public class FormElementConverter implements ReadConverter {
  ...
  public Object unmarshal(HierarchicalStreamReader reader, UnmarshallingContext context) {
    ...
    if (attributeType == null) {
      attributeType = nodeName;
    }

    var elementType = FormElementType.valueByName(attributeType.replace("form:", ""));
    ...
    readerContext = new FormElementReaderContext(elementType, nodeName, reader);
