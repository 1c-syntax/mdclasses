...
public class SubsystemConverter implements ReadConverter {
  ...
  public Object unmarshal(HierarchicalStreamReader reader, UnmarshallingContext context) {
    ...
    if (SUBSYSTEM_NODE.equals(name) && reader.getAttributeCount() == 0) { // дочерняя подсистема строкой

      var rootFolder = DesignerPaths.mdoTypeFolderPathByMDOPath(currentPath).toString();
