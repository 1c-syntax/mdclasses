...
@DesignerConverter
@Slf4j
public class FormParameterCommandConverter implements ReadConverter {
  ...
  public Object unmarshal(HierarchicalStreamReader reader, UnmarshallingContext context) {
    ...
    if (readerContext.getRealClass().isAssignableFrom(FormCommand.class)) {
  ...
  public boolean canConvert(Class type) {
    return type == FormCommand.class || type == FormParameter.class;
  }
}
