...
public class XStreamFactory {
  ...
  private void processAnnotationsForMDO(XStream xstream) {
    ...
    xstream.processAnnotations(IntegrationService.class);
    xstream.processAnnotations(IntegrationServiceChannel.class);
  ...
  private void addClassAliases(XStream xStream) {
    ...
    xStream.alias("mdclass:IntegrationService", IntegrationService.class);
