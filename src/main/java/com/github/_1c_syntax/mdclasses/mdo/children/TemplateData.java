...
public class TemplateData<T> {
  ...
  public com.github._1c_syntax.bsl.mdo.data_storage.TemplateData buildMDObject() {
    if (data instanceof DataCompositionSchema) {
      return ((DataCompositionSchema) data).buildMDObject();
    } else {
