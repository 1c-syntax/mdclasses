...
@XmlType("PictureXCF", namespace = "http://v8.1c.ru/8.3/xcf/readable", propOrder = {
    "ref",
    "url",
    "abs",
    "loadTransparent",
...
public class PictureXCF {
    ...
    @JsonProperty("LoadTransparent")
    protected Boolean loadTransparent;
    @JsonProperty("TransparentPixel")
    protected Point transparentPixel;
    @JsonProperty("GlyphPoint")
    protected Point glyphPoint;
    @JsonProperty("ZipEntryParams")
