...
@XmlType("RadioButtonsData", namespace = "http://v8.1c.ru/8.2/managed-application/logform", propOrder = {
    "valList",
    "txtClr",
    "fnt",
    "brdClr",
...
public class RadioButtonsData {
    ...
    @JsonProperty("elementTitleHeight")
    protected BigDecimal elementTitleHeight;
    @JsonProperty("elementHeight")
    protected BigDecimal elementHeight;
    @JsonProperty("elementWidth")
