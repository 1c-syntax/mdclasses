 ...
 * 
 */
@XmlType("ManagedFormButtonType", namespace = "http://v8.1c.ru/8.2/managed-application/logform")
@XmlEnum
public enum ManagedFormButtonType {

    @JsonProperty("CommandBarButton")
    COMMAND_BAR_BUTTON("CommandBarButton"),
    @JsonProperty("UsualButton")
    USUAL_BUTTON("UsualButton"),
    @JsonProperty("Hyperlink")
    HYPERLINK("Hyperlink"),
    @JsonProperty("CommandBarHyperlink")
