 ...
 * 
 */
@XmlType("CommandGroupCategory", namespace = "http://v8.1c.ru/8.2/managed-application/core")
@XmlEnum
public enum CommandGroupCategory {

    @JsonProperty("NavigationPanel")
    NAVIGATION_PANEL("NavigationPanel"),
    @JsonProperty("ActionsPanel")
    ACTIONS_PANEL("ActionsPanel"),
    @JsonProperty("FormNavigationPanel")
    FORM_NAVIGATION_PANEL("FormNavigationPanel"),
    @JsonProperty("FormCommandBar")
